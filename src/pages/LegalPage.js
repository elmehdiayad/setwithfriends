...
const TermsOfService = () => (
  <>
    ...
    <Typography variant="body1" gutterBottom>
      ...
      <Link href="/">https://cue.ma/</Link>, you are agreeing to be
    ...
    <Typography variant="body1" gutterBottom>
      ...
      (information or software) on Cue.ma' website for personal,
    ...
    <Typography variant="body1" gutterBottom>
      ...
      restrictions and may be terminated by Cue.ma at any time. Upon
    ...
    <Typography variant="body1" gutterBottom>
      The materials on Cue.ma' website are provided on an 'as is'
      basis. Cue.ma makes no warranties, expressed or implied, and
    ...
    <Typography variant="body1" gutterBottom>
      Further, Cue.ma does not warrant or make any representations
    ...
    <Typography variant="body1" gutterBottom>
      In no event shall Cue.ma or its suppliers be liable for any
      damages (including, without limitation, damages for loss of data or
      profit, or due to business interruption) arising out of the use or
      inability to use the materials on Cue.ma' website, even if Set
      with Friends or a Cue.ma authorized representative has been
    ...
    <Typography variant="body1" gutterBottom>
      The materials appearing on Cue.ma' website could include
      technical, typographical, or photographic errors. Cue.ma does
      not warrant that any of the materials on its website are accurate,
      complete or current. Cue.ma may make changes to the materials
    ...
    <Typography variant="body1" gutterBottom>
      Cue.ma has not reviewed all of the sites linked to its website
      and is not responsible for the contents of any such linked site. The
      inclusion of any link does not imply endorsement by Cue.ma of
      the site. Use of any such linked website is at the user's own risk.
    </Typography>

    <Typography variant="h6">7. Modifications</Typography>
    <Typography variant="body1" gutterBottom>
      Cue.ma may revise these terms of service for its website at any
...
const PrivacyPolicy = () => (
  <>
    ...
    <Typography variant="body1" gutterBottom>
      Your privacy is important to us. It is Cue.ma' policy to respect
      your privacy regarding any information we may collect from you across our
      website, <Link href="/">https://cue.ma/</Link>, and other
